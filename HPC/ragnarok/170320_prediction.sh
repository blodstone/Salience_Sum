...
python $HOME/postprocess/retrieve_last_model.py $MODEL
python $HOME/summarize.py -input $DATA/ready/test.salience.tsv -vocab_path $MODEL/vocabulary -model $MODEL/pick.th -model_config $MODEL/config.json -output_path $DATA/result_3/seq2seq_clean_16_300.out -batch_size 24 --cuda --use_salience
